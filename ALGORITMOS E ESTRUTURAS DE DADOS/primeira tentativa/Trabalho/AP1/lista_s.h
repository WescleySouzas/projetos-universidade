...
*/
bool lista_inserir_fim(lista *l, item it); // enqueue
...
Saída: true se inserido com sucesso; false caso contrário
*/
bool lista_inserir_inicio(lista *l, item it); // enqueue

/*
Insere um item na k-ésima posição da lista lista
Entrada: referência para a lista l e o item it a ser inserido
Saída: true se inserido com sucesso; false caso contrário
*/
bool lista_inserir_meio(lista *l, item it, int k); // enqueue
